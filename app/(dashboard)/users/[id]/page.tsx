      ...
      <div className="card-glass-dark relative overflow-hidden">
        ...
        <div className="relative">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className={`badge ${user.authMethod === 'GOOGLE' ? 'badge-info' : 'badge-gray'}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-white/10">
            <div>
              <p className="text-gray-400 text-sm mb-1">Cuentas Asociadas</p>
              <p className="text-2xl font-bold">{user.accounts.length}</p>
            </div>
            <div>
              ...
              <p className="text-2xl font-bold">
                {user.emailVerifiedAt ? (
                  <span className="text-green-400 flex items-center gap-2">
                    <i className="ki-duotone ki-verify text-xl">
                      <span className="path1"></span>
                      <span className="path2"></span>
                    </i>
                    Verificado
                  ...
                  <span className="text-yellow-400 flex items-center gap-2">
                    <i className="ki-duotone ki-time text-xl">
                      <span className="path1"></span>
                      <span className="path2"></span>
                    </i>
                    Pendiente
            ...
            <div>
              <p className="text-gray-400 text-sm mb-1">Credito Onboarding</p>
              <p className="text-2xl font-bold">
                {user.onboardingCreditUsedAt ? (
                  ...
                  <span className="text-gray-400 flex items-center gap-2">
                    <i className="ki-duotone ki-minus-circle text-xl">
                      <span className="path1"></span>
                      <span className="path2"></span>
                    </i>
                    Disponible
        ...
        <div className="card">
          ...
          <dl className="space-y-4">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <dd className="font-mono text-sm bg-gray-100 px-3 py-1 rounded-lg">{user.uid}</dd>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <dt className="text-gray-500 flex items-center gap-2">
